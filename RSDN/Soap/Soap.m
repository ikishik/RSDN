...
+ (NSString*) createEnvelope: (NSString*) method forNamespace: (NSString*) ns forParameters: (NSString*) params withHeaders: (NSDictionary*) headers
{
    ...
    //NSString* soapRequest = [NSString stringWithFormat:@"<?xml version='1.0' encoding='utf-8'?><s:Envelope xmlns:s='http://schemas.xmlsoap.org/soap/envelope/'><s:Body><SOAPREQUEST xmlns='%@'xmlns:i='http://www.w3.org/2001/XMLSchema-instance'></SOAPREQUEST></s:Body></s:Envelope>", ns];
	//soapRequest = [soapRequest stringByReplacingOccurrencesOfString:@"SOAPREQUEST" withString:method];
